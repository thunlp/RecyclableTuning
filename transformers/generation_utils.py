...
class GenerationMixin:
    ...
    def generate(
        self,
        compute_acc: Optional[bool] = False,
        std_ans: Optional[list] = None,
        inputs: Optional[torch.Tensor] = None,
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        if compute_acc:
            p_acc = [1 for _ in range (len(std_ans))]
        count = 0
        ...
        while True:
            ...
            if compute_acc:
                ...
                for i in range(len(std_ans)):
                    row = next_tokens_scores[i]
                    exp = torch.exp(row)
                    a = float(exp[9].item())
                    b = float(exp[115].item())
                    c = float(exp[75].item())
                    sum = a + b + c
                    # print(b, sum)
                    # input()
    ...
    def constrained_beam_search(
        ...
        **model_kwargs,
        ...
        # print("into constrained beam search")
        # input()
