...
def main():
    ...
    # make the flat pet into tensor again
        ...
        tmp_dict1 = {k: v for k, v in model1.state_dict().items()}
        keys = [k for k in  tmp_dict1.keys()][1:]
    ...
    if "train_itp" not in flat2:
        ...
        tmp_dict2 = {k: v for k, v in model2.state_dict().items()}
        keys = [k for k in  tmp_dict2.keys()][1:]
